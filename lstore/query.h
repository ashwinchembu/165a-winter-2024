...
public:
    ...
    std::optional<int> sum(int start_range, int end_range, int aggregate_column_index);
    std::optional<int> sum_version(int start_range, int end_range, int aggregate_column_index, int relative_version);
